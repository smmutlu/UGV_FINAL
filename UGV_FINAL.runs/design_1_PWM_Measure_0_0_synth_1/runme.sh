...
HD_PWD='C:/Users/Sean/Documents/UGV_PROJECTS/UGV_FINAL/UGV_FINAL.runs/design_1_PWM_Measure_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PWM_Measure_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PWM_Measure_0_0.tcl
